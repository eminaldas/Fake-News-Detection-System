...
function GridSkeleton() {
    return (
        <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 auto-rows-[220px] sm:auto-rows-[260px] mb-4">
            ...
            {/* Alt grid */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 auto-rows-[220px] sm:auto-rows-[260px]">
                {[0, 1, 2].map(i => (
