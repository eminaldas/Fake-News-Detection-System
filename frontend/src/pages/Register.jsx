        ...
        <div className="fixed inset-0 z-[9999] flex flex-col items-center justify-center"
            ...
            <div className="flex flex-col items-center gap-6">
                <div className="relative w-16 h-16">
                    ...
                    <div className="absolute inset-2 flex items-center justify-center font-manrope font-black text-lg"
                         style={{ color: 'var(--color-brand-primary)' }}>
                        ne
                    </div>
                </div>
                <div className="text-center">
                    <p className="text-sm font-manrope font-bold" style={{ color: 'var(--color-text-primary)' }}>
                        {title}
                    </p>
                    <p className="text-xs mt-1" style={{ color: 'var(--color-text-primary)', opacity: 0.5 }}>
                        {subtitle}
                    </p>
                </div>
            </div>
...
function GoogleLoadingOverlay() {
    return <LoadingOverlay title="Hesabınız oluşturuluyor" subtitle="Google ile doğrulanıyor..." />;
}
...
const Register = () => {
    ...
    return (
        ...
        {registerLoading && <LoadingOverlay title="Hesabınız oluşturuluyor" subtitle="Lütfen bekleyin..." />}
