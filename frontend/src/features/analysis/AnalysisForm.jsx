...
const AnalysisForm = ({ onAnalyze, onAnalyzeUrl, loading, isPolling }) => {
    ...
    return (
        ...
        ">
            ...
            {/* Input Alanı — key ile mod değişimi animasyonlu */}
            <div key={mode} className="p-1 flex-grow flex flex-col animate-fade-in">
                {mode === 'text' ? (
                    <textarea
                        ...
                        className="
                            w-full flex-grow min-h-[140px] md:min-h-[160px] p-4 md:p-6
                            text-tx-primary
                            bg-transparent border-0 focus:ring-0
                            resize-none text-base md:text-lg lg:text-xl font-medium outline-none
                        ...
                        <div className="flex items-center gap-3 rounded-xl border border-brutal-border dark:border-surface-solid bg-surface-solid px-3 md:px-4 py-3 focus-within:border-tx-primary transition-colors">
                            ...
                            <input
                                ...
                                className="
                                    ...
                                    text-tx-primary font-medium text-sm md:text-base
                                    placeholder:text-tx-secondary
                                    disabled:opacity-50
                                "
                            />
            ...
            <div className="px-4 md:px-6 py-3 md:py-4 flex justify-between items-center border-t border-brutal-border/30 dark:border-surface-solid transition-colors duration-300">
                <span className="text-xs font-semibold text-tx-secondary">
                    {mode === 'text'
                        ...
                        : (() => { try { return url ? new URL(url.startsWith('http') ? url : 'https://' + url).hostname : '—'; } catch { return url || '—'; } })()}
                </span>
                <button
                    ...
                    className="
                        ...
                        border border-brutal-border dark:border-surface-solid
                        px-6 md:px-8 py-2.5 md:py-2 rounded-xl font-bold text-sm
