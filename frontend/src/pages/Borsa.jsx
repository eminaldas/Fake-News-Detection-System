...
export default function Borsa() {
    ...
    return (
        <div className="w-full max-w-3xl mx-auto px-4 py-7 flex flex-col gap-3.5">
            <h1 className="font-extrabold text-2xl tracking-tight" style={{ color: 'var(--color-text-primary)' }}>
            ...
            <div className="flex gap-1.5 flex-wrap">
                {TABS.map(t => (
                    <button key={t} type="button" onClick={() => setCat(t)}
                            className="font-mono text-[11px] font-bold px-3.5 py-1.5 border transition-colors"
                            style={cat === t
